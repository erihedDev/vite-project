    ...
    <nav className='w-full flex justify-center fixed backdrop-blur z-1'>
      <div className='h-16 mx-4 w-full md:w-[48rem] flex justify-between items-center text-neutral-50'>
        <div className='flex text-lg'>
          <h1 className='font-bold'><a href={'https://eriheddev.github.io/vite-project/'}>Erik Hedlund</a></h1>
        ...
        <div>
          <a className=' text-black' href='https://github.com/erihedDev/vite-project'><FontAwesomeIcon className='p-2 bg-orange-200 hover:bg-orange-300 duration-150 rounded-full text-3xl' icon={faGithub}/></a>
        </div>
      </div>
    </nav>
  )
